...
public class PIMPage extends CommonMethods {
	...
	public void addemployee(Map<Object,Object>data,ExtentTest test) {
		...
		emp_id.get(1).clear();
		emp_id.get(1).sendKeys(stringValue(data,"EmailID")+randomnumbergenerator());			
		pic_upload.click();
		StringSelection strSelection = new StringSelection("C:\\Users\\PAWAN\\eclipse-workspace\\.metadata\\DataDrivenFramework\\src\\test\\resources\\Screenshot\\24-11-2022 02\\LoginSucess.png");
	...
	test.log(Status.PASS, "Employee has been added sucessfully");
		}
}
}
